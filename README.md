...
<div style="display: flex; flex-wrap: wrap; justify-content: space-between;">
  <img src="./examples/title-page.png" alt="title-page" width="400" style="margin-bottom: 10px; flex-basis: 49%;"/>
  <img src="./examples/declaration.png" alt="declaration" width="400" style="margin-bottom: 10px; flex-basis: 49%;"/>
  <img src="./examples/chapter-01.png" alt="chapter-01" width="400" style="margin-bottom: 10px; flex-basis: 49%;"/>
  <img src="./examples/figues.png" alt="figures" width="400" style="margin-bottom: 10px; flex-basis: 49%;"/>
</div>
